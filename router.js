...
<head>
    ...
    <style>
        ...
        *,*:before,*:after{box-sizing:border-box}
        ...
        .site-header .logo img{height:38px;width:auto;transition:filter var(--transition-speed) ease;transform:translateZ(0);background-color:transparent}
        ...
        .site-header:not(.scrolled) .logo .logo-unscrolled{height:39px;transform:translate(0px,2px)}
